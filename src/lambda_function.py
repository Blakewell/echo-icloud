...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Echo iCloud Skill. " \
                    "To test the skills configuration say,  " \
                    "Find my iPhone"
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for using the Echo iCloud Skill. " \
                    "Have a nice day! "
...
def on_intent(intent_request, session):
    ...
    if intent_name == "FindPhoneIntent":
        return find_phone()
